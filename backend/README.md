...
## Project Structure
    ...
    ├── testapiautodatamod_124066  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_124066`
...
2. Clone this repo and `cd testapiautodatamod_124066`
